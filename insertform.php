...
<head>
  ...
  function validate(){  
    ...
    if (isNaN(mobile) || mobile.length < 10 || mobile.length > 10){  
      document.getElementById("numloc").innerHTML="Enter Numeric value with length 10 only";  
      return false;  
    }else{  
      return true;  
    }  
...
<?php include "header.php";?>
              ...
              <form class="user" name="myform" action="insertform.php" method="post" onsubmit="return validate()">
                ...
                <div class="form-group">
                    <input type="text" class="form-control form-control-user" id="mobile" name="mobile" placeholder="mobile number" required><span id="numloc"></span>
                </div>
